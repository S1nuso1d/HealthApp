...
object FeatureGuideContent {
    ...
    val dashboard = listOf(
        FeatureGuidePage(
            title = "Главная — ваша сводка",
            lead = "Здесь собраны сон, вода, питание и активность за сегодня. Чем чаще вы вносите данные, тем точнее индекс здоровья и советы.",
            bullets = listOf(
                "Индекс здоровья — общая картина дня от 0 до 100.",
                "Потяните вниз, чтобы обновить данные с сервера.",
                "Плитки внизу ведут в нужный раздел одним нажатием.",
            ),
        ...
        FeatureGuidePage(
            title = "Настроение и AI",
            lead = "Отметка самочувствия помогает видеть связь сном, стрессом и активностью. AI-подсказки строятся по вашему дневнику.",
            bullets = listOf(
                "Кратко отметьте настроение, энергию и стресс — это займёт несколько секунд.",
                "Подсказки на главной обновляются по вашим метрикам.",
                "Кнопки «AI-помощник» и «Сообщество» — быстрый доступ к чату и ленте.",
            ),
            icon = Icons.Filled.AutoAwesome,
        ),
        FeatureGuidePage(
            title = "Цели и неделя",
            lead = "Календарь показывает дни, когда закрыты цели. Блок «Неделя» — средние значения; им можно поделиться.",
            bullets = listOf(
                "Зелёные дни в календаре — все цели выполнены.",
                "Рекомендации внизу — персональные советы по вашим данным.",
    ...
    val sleep = listOf(
        ...
        FeatureGuidePage(
            title = "Диктофон и AI-сводка",
            lead = "Во время сна можно записывать звуки — храп, разговоры. После сессии AI составит краткую сводку (нужен запущенный сервер с LLM).",
            bullets = listOf(
    ...
    val profile = listOf(
        FeatureGuidePage(
            ...
            lead = "Здесь ваши данные, цели на день и настройки приложения. Цели сна, воды и шагов используются на главной и в разделах.",
            bullets = listOf(
                "Полоска целей вверху — быстрый обзор норм на день.",
                "«Цели и привычки» — изменить сон, воду, шаги и калории.",
                "Рост и вес влияют на расчёт ИМТ и рекомендации.",
            ),
            icon = Icons.Filled.Person,
        ),
        FeatureGuidePage(
            title = "Питание и аллергии",
            lead = "Укажите вегетарианство и аллергии — AI-план питания и советы будут их учитывать.",
            bullets = listOf(
