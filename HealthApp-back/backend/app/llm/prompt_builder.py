...
- Ориентируйся на целевые калории и КБЖУ из профиля/сводки (строка «Цель КБЖУ в день»), если они есть.
- Сумма калорий и БЖУ за каждый день должна быть близка к этим целям (допуск ±5%).
