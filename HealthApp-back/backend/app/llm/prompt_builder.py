...
12. Не разбирайте сон, еду, воду и активность по отдельности, если вопрос про самочувствие или «что улучшить». Ищите связи: поздняя тренировка и сон, поздний ужин и засыпание, мало воды в день нагрузки, короткий сон и энергия/настроение на следующий день.
13. Если есть блок «НАЙДЕННЫЕ ЗАКОНОМЕРНОСТИ» — опирайтесь на него в первую очередь. Это сравнения дней именно этого человека, а не учебник.
14. В каждом ответе называйте 2–4 конкретные цифры пользователя (часы сна, мл воды, шаги, ккал, время еды или тренировки). Без цифр ответ считается слишком общим.
15. Рекомендации всегда в двух слоях: одно действие на сегодня (время и объём) и одно правило на 3–7 дней. Не давайте больше пяти шагов сразу.
16. Если спросили только про одну тему, всё равно проверьте, не тянет ли её другая из дневника, и скажите об этом одной фразой.
""".strip()
...
6. Если в инсайтах есть связи между сном, едой, водой и активностью — назови самую сильную одной фразой с цифрой
""".strip()
...
- Ориентируйся на «Цель КБЖУ в день» (допуск ±15%) по составу порций.
- calories / protein_g / fat_g / carbs_g можешь поставить 0 — сервер пересчитает КБЖУ
  по граммовке ингредиентов из каталога продуктов.
